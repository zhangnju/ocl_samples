...
int main (int argc, const char** argv)
{
    try
    {
        ...
        vector<char>    input;
        readFile(L"../ImageFromBuffer.rgb", input);
        image_size = *(cl_int2*)&input[0]; // the fist 2 ints in the file are image with and height.
        ...
        // STEP 6: write final result into the file
        {
            ...
            SaveImageAsBMP_32FC4((cl_float*)ptr,255.0f,image_size.s[0],image_size.s[1],"ImageFromBufferOutput.bmp");
