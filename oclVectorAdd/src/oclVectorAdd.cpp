...
int main(int argc, char **argv)
{
    ...
    ciErr1 = clEnqueueNDRangeKernel(cqCommandQueue, ckKernel, 1, NULL, &szGlobalWorkSize, &szLocalWorkSize, 0, NULL, &event);
	...
	std::cout <<  "it takes " << double( duration.count() / 1000.0 ) << " ms" << std::endl;
